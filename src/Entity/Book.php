...
#[ApiResource(
	normalizationContext: ['groups' => ['book:read', 'user:read']],
...
class Book
{
	...
	#[Groups(['book:read', 'review:read', 'book:write'])]
	...
	/**
	 * @param Collection $bookCategories 
	 * @return self
	 */
	public function setBookGenres(Collection $bookCategories): self
	{
